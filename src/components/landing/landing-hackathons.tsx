 ...
 * tutuluyor; metinler `NextIntlClientProvider` üzerinden geliyor.
 */
export function LandingHackathons() {
  ...
  const slides: Slide[] =
    hackathons.length > 0
      ? hackathons.map((hackathon) => ({
          ...
          award: localize(hackathon.award, locale),
          year: hackathon.year,
          detail: hackathon.detail
            ? localize(hackathon.detail, locale)
            : undefined,
